 ...
 * as org.fs.dx.presenters.NumberInputPresenter
 */
public class NumberInputPresenter extends AbstractPresenter<INumberInputView> implements INumberInputPresenter,
    ...
    public NumberInputPresenter(INumberInputView view) {
        super(view);
    }
    ...
    @Override protected String getClassTag() {
        return NumberInputPresenter.class.getSimpleName();
    }
    ...
    @Override public void onClick(View btn) {
        if (view.isAvailable()) {
            ...
            final INumberInputView.Callback callback = view.getCallback();
            switch (id) {
                case R.id.btnOk: {
